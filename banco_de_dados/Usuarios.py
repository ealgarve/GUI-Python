...
class Usuarios(object): # classe que modela o usuário
    ...
    def insertUser(self):
        ...
        try:
            ...
            return "Ocorreu um erro de digitação de usuário"
    ...
    def updateUser(self):
        ...
        try:
            ...
            c.execute("update usuarios set nome = '" + self.nome + "', telefone = '" + self.telefone + "', email = '" + self.email +
             "', usuario = '" + self.usuario + "', senha = '" + self.senha + "' where idusuario = " + self.idusuario + " ")
            ...
            return "Ocorreu um erro de alteração do usuário"
